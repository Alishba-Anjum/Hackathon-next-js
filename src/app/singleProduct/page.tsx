...
//           {/* Your existing code for size and color options */}
...
//           {/* Your existing code for these details */}
//         </div>
//       </div>
...
//       {/* Product Description, Additional Information, Reviews */}
//       {/* Your existing description and additional info section */}
//       <Footer />
//     </>
//   );
// };
...
//   const { id } = router.query; // Get the productId from the URL

//   // Fetch the product details on component mount or when productId changes
//   useEffect(() => {
//     if (id) {
